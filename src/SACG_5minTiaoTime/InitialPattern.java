...
//        DataReader CopyFlightReader = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\CopyFlight.txt");
...
//        }
        ...
        DataReader RouteNumR = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\InitialRouteNum1000.txt");
        DataReader RouteR = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\InitialRoute1000.txt");
        for (int airc = 0; airc < AircNum; airc++) {
...
//            System.out.println(Arrays.toString(AirpTypeCFNum[ap]));
        ...
        //输出初始Pattern
        FileWriter InitialPatternNumFW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\InitialPatternNum"+Initial1PatternNum+"~"+gateTypeNum+".txt");
        for(int ap=0; ap< ApNum; ap++){
        ...
        FileWriter InitialPatternFW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\InitialPattern"+Initial1PatternNum+"~"+gateTypeNum+".txt");
        for(int ap=0; ap< ApNum; ap++){
            for(int tp=0; tp<2; tp++){
