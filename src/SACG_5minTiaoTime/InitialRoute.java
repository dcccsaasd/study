...
//        InputDataReader ApSlotDepReader = new InputDataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\ApSlotDep.txt");
//        int[][] ApSlotDep = ApSlotDepReader.readIntArrayArray();
//
//        InputDataReader ApSlotArrReader = new InputDataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\ApSlotArr.txt");
...
//        int Initial1RouteNum = 1000;
            ...
            FileWriter InitialRouteNumFW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\InitialRouteNum"+Initial1RouteNum+".txt");
            for(int airc=0; airc< Aircraft.length; airc++){
            ...
            FileWriter InitialRouteFW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_5minTiaoTime\\Data\\"+DataBase+"\\InitialRoute"+Initial1RouteNum+".txt");
            for(int airc=0; airc< Aircraft.length; airc++){
