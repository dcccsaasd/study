...
public class LPex1 {
   ...
   static void populateByColumn(IloMPModeler model,
      ...
      //numVar(),以列的方式添加变量，以此组成目标函数和约束的表达式
