@echo off
REM Copyright IBM Corporation 2013, 2019. All Rights Reserved.
...
START /MIN %CPLEX_STUDIO_DIR129%\cplex\bin\x64_win64\cplex.exe -worker=tcpip -address=localhost:%1 -pidfile=tcpippid -logfile=tcpip.log
