...
public class SAGR {
    ...
    static void TT(int DataBase, double forcedCoveredPairInitialPatternTimeLim, double OneBestPatternTimeLim, double NegativeReducedCostPatternTimeLim, double TotalTimeLim) throws IOException, InputDataReader.InputDataReaderException, IloException {
        ...
        /*航班数据导入*/
        InputDataReader FlightReader = new InputDataReader("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\Flight.txt");
        ...
        /*飞机数据导入*/
        InputDataReader AircReader = new InputDataReader("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\Aircraft.txt");
        ...
        /*时隙数据导入*/
        DataReader ApSlotDepReader = new DataReader("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\ApSlotDep.txt");
        DataReader ApSlotArrReader = new DataReader("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\ApSlotArr.txt");
...
//        if(seqFlag == 0){
//            InitialRouteNumRString = "D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\RouteNum"+InitialRouteSize+".txt";
//            InitialRouteRString = "D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\Route"+InitialRouteSize+".txt";
//        }else{
//            InitialRouteNumRString = "D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialRouteNum"+InitialRouteSize+".txt";
//            InitialRouteRString = "D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialRoute"+InitialRouteSize+".txt";
//        }

//        InitialRouteNumRString = "D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialRouteNum"+InitialRouteSize+".txt";
//        InitialRouteRString = "D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialRoute"+InitialRouteSize+".txt";
        InitialRouteNumRString = "D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\RouteNum"+InitialRouteSize+".txt";
        InitialRouteRString = "D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\Route"+InitialRouteSize+".txt";
        ...
        /*初始机位Pattern导入*/
        DataReader InitialPatternNumR = new DataReader("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialPatternNum"+InitialPatternNum+"~"+gateTypeNum+".txt");
        DataReader InitialPatternR = new DataReader("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialPattern"+InitialPatternNum+"~"+gateTypeNum+".txt");
        for(int ap=0; ap< ApNum; ap++) {
...
//            FileWriter RouteNum510FW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\betterRouteNum"+1000+".txt");
...
//            FileWriter Route510FW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\betterRoute"+1000+".txt");
//            for(int airc=0; airc< Aircraft.length; airc++){
//                for (int i = 0; i < AircRouteNum[airc]; i++) {
...
//                System.out.println(Arrays.toString(chooseRoute));
            ...
            while (true){
                ...
                if(phase1AirpTypeReducedcostFlagSum==2*ApNum||GRphase1loop>=5){
    ...
    public static void main(String[] args) throws IOException, InputDataReader.InputDataReaderException, IloException{
        int DataBase;
        double forcedCoveredPairInitialPatternTimeLim;
        double OneBestPatternTimeLim;
        double NegativeReducedCostPatternTimeLim;
        double TotalTimeLim;
...
//        System.out.println("------------\n\n\n");
        ...
        for(int i=2; i<=5; i++){
            for(int j=1; j<=3; j++){
                for(int k=1; k<=2; k++){
                    OutConsole.write("D:\\IDEA\\works\\src\\SACG_20minTiaoTime10\\10\\database10 1000 "+i+" "+j+" "+k+".txt");
                    System.out.println("------------");
                    TT(10, i, j, k, 1800);
                    System.out.println("------------\n\n\n");
                }
