...
//        System.out.println("DataBase = "+DataBase+", Initial1RouteNum = "+Initial1RouteNum+", NegativeReducedCostRouteNum = "+NegativeReducedCostRouteNum);
        ...
        DataReader ApSlotDepReader = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\ApSlotDep.txt");
        DataReader ApSlotArrReader = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\ApSlotArr.txt");
...
//        }
        ...
        for(int a=1; a<=1; a++){
            for(int b=1;b<=1; b++){
                ...
                int[] AircRouteNum = new int[AircNum];
                int[][][] AircLegnumDlytimeSwapnumRoute = new int[AircNum][][];
                DataReader InitialRouteNumR = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialRouteNum"+Initial1RouteNum+".txt");
                DataReader InitialRouteR = new DataReader("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\InitialRoute"+Initial1RouteNum+".txt");
                for (int airc = 0; airc < AircNum; airc++) {
                    AircRouteNum[airc] = InitialRouteNumR.next();
                    AircLegnumDlytimeSwapnumRoute[airc] = new int[AircRouteNum[airc]][3+MaxRouteLegNum];
                }
...
//                FileWriter RouteNum510FW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\RouteNum"+1000+".txt");
...
//                FileWriter Route510FW = new FileWriter("D:\\idea_javaproject\\idea_javaproject\\src\\SACG_20minTiaoTime10\\Data\\"+DataBase+"\\Route"+1000+".txt");
//                for(int airc=0; airc< Aircraft.length; airc++){
//                    for (int i = 0; i < AircRouteNum[airc]; i++) {
